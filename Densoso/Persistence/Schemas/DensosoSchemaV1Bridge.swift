...
enum DensosoSchemaV1Bridge: VersionedSchema {
    ...
    @Model final class UserProfile {
        ...
        var activityLevel: String; var dailyDeficitTarget: Int
    ...
    @Model final class MealRecord {
        ...
        @Relationship(deleteRule: .cascade, inverse: \DensosoSchemaV1Bridge.DishEntry.mealRecord)
        var dishes: [DensosoSchemaV1Bridge.DishEntry] = []
        init(date: Date = Date()) {
            self.date = date; mealType = "lunch"; totalCaloriesKcal = 0
            proteinG = 0; fatG = 0; carbsG = 0; confidence = "medium"; algorithmVersion = "v2"; createdAt = Date()
        }
    }

    @Model final class DishEntry {
        var dishName: String; var cookingMethod: String?; var ingredientJSON: String
        var estimatedCaloriesKcal: Int; var estimatedProteinG: Double
        var estimatedFatG: Double; var estimatedCarbsG: Double
        var confidenceScore: Double; var userCorrectionFactor: Double?; var createdAt: Date
        var mealRecord: DensosoSchemaV1Bridge.MealRecord?
    ...
    @Model final class WorkoutRecord {
        @Attribute(.unique) var id: UUID = UUID()
        var date: Date; var type: String; var durationMinutes: Int
        var estimatedCaloriesBurned: Int; var intensity: String; var notes: String?; var createdAt: Date
        var updatedAt: Date?; var healthKitUUID: UUID?; var logicalSessionID: UUID?
        var workoutOrigin: String?; var energySource: String?
        var sourceBundleIdentifier: String?; var sourceVersion: String?; var sourceRevision: String?
        var deviceName: String?; var deviceModel: String?; var dataQuality: String?
        var routeStatus: String?; var routePointCount: Int?
        init(date: Date = Date()) {
            self.date = date; type = "other"; durationMinutes = 0; estimatedCaloriesBurned = 0
            intensity = "moderate"; createdAt = Date()
        }
    }

    @Model final class DailyMetrics {
        @Attribute(.unique) var date: Date
        var bmrKcal: Int; var activeCaloriesKcal: Int; var totalExpenditureKcal: Int
        var totalIntakeKcal: Int; var deficitKcal: Int
        var proteinG: Double; var fatG: Double; var carbsG: Double
        var mealCount: Int; var workoutCount: Int; var computedAt: Date
        init(date: Date) {
    ...
    @Model final class WeeklyReport {
        ...
        var weekEndDate: Date; var totalDeficitKcal: Int; var avgDailyDeficitKcal: Double
        var projectedWeightLossKg: Double; var avgProteinG: Double; var avgFatG: Double; var avgCarbsG: Double
        var bestDay: Date?; var worstDay: Date?; var mealsCount: Int; var workoutsCount: Int
        var compliance: Double; var generatedAt: Date
        init(weekStartDate: Date, weekEndDate: Date) {
            self.weekStartDate = weekStartDate; self.weekEndDate = weekEndDate
            totalDeficitKcal = 0; avgDailyDeficitKcal = 0; projectedWeightLossKg = 0
            avgProteinG = 0; avgFatG = 0; avgCarbsG = 0; mealsCount = 0; workoutsCount = 0
            compliance = 0; generatedAt = Date()
        }
    }
    ...
    @Model final class ScheduleEvent {
        ...
        init(date: Date = Date(), title: String = "") {
            self.date = date; self.title = title; startTime = date; createdAt = Date()
        }
    }
